...
PLATFORM=VC-CE
CC=$(CC)
CFLAG= /O1i /W3 /WX /GF /Gy /nologo -DUNICODE -D_UNICODE -DOPENSSL_SYSNAME_WINCE -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -DNO_CHMOD -I$(WCECOMPAT)/include -I"C:\Program Files (x86)\Windows CE Tools\wce600\Motorola MC3100c60 Windows CE6.0 PSDK\Include\Armv4i" -DOPENSSL_SMALL_FOOTPRINT -D_WIN32_WCE=600 -DUNDER_CE=600 -DWCE_PLATFORM_VC-CE -DARM -D_ARM_ -DARMV4I -QRarch4T -QRinterwork-return /Fdout32dll_$(TARGETCPU) -DOPENSSL_NO_CAMELLIA -DOPENSSL_NO_SEED -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_TLSEXT -DOPENSSL_NO_CMS -DOPENSSL_NO_CAPIENG -DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE
...
LINK=link
LFLAGS=/nologo /opt:ref /subsystem:windowsce,6.00 /machine:THUMB /NODEFAULTLIB:oldnames.lib /NODEFAULTLIB:libc.lib coredll.lib corelibc.lib
RSC=rc
...
MKLIB=lib
MLFLAGS= /nologo /opt:ref /subsystem:windowsce,6.00 /machine:THUMB /NODEFAULTLIB:oldnames.lib /NODEFAULTLIB:libc.lib coredll.lib corelibc.lib /dll
ASM=ml /Cp /coff /c /Cx
